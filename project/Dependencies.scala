...
object Dependencies {
  ...
  lazy val log4jApi        = "org.apache.logging.log4j"    % "log4j-api"        % "2.25.1"
  lazy val log4jCore       = "org.apache.logging.log4j"    % "log4j-core"       % "2.25.1"
  lazy val log4jSlf4jImpl  = "org.apache.logging.log4j"    % "log4j-slf4j-impl" % "2.25.1"
